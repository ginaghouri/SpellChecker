...
def check_spelling():
    ...
    cs = Label(root, text="Correct text is :", font=("Comic Sans MS", 20), bg="#91D8E4", fg="#460C68")
    cs.place(x=100, y=250)
    spell.config(text=right)

Button = Button(root, text="Check", font=("Comic Sans MS", 20, "bold"), fg="white", bg="#758ED9", command=check_spelling)
Button.pack()
